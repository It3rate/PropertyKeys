...
//{
//    /// <summary>
//    /// Class to store data and special line finding/rendering capabilities of a vis quad.
//    /// </summary>
//    public class QuadSeries: FloatSeries, IDrawableSeries
//    {
//        public override SeriesType Type => SeriesType.Float;

//        public override int Count => (int)(_floatValues.Length / VectorSize);

//        private int _polyLineCount = 4;
...
//        public QuadSeries(float[] values) : base(2, values)
//        {
//        }
...
//        {
//            var result = new QuadSeries((float[])FloatDataRef.Clone());
//            return result;
//        }
//    }
//}
