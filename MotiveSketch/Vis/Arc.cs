...
{
    // fusion: 3 points (start, end, perim), centerpoint (center, radius point, degrees), tangent (point extends line, point defines dist and degrees)
    // fusion ellipse: center, axis endpoint, point on ellipse
