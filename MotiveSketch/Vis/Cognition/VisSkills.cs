...
namespace Motive.Vis
{
	public class VisSkills
	{
        ...
        public Quad LetterR(VisPad<Point> focusPad, VisPad<Stroke> viewPad)
        {
            ...
            var letterbox = new Quad(0.25f, 0.5f, 0f, 0f);
			focusPad.Paths.Add(letterbox);
		...
		public Quad LetterC(VisPad<Point> focusPad, VisPad<Stroke> viewPad)
		{
			var letterbox = new Quad(0.5f, 0.5f, 0f, 0f);
            focusPad.Paths.Add(letterbox);
            var rightLine = letterbox.GetLine(CompassDirection.E);
        ...
        public Quad LetterB(VisPad<Point> focusPad, VisPad<Stroke> viewPad)
        {
            var letterbox = new Quad(0.30f, 0.5f, 0f, 0f);
            focusPad.Paths.Add(letterbox);
