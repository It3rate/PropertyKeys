...
namespace Motive.Vis
{
	...
	public static class CompassDirectionExtensions
	{
        ...
        public static Line GetLineFrom(this CompassDirection direction, Quad rect, float offset = 0)
        {
            Line result;
            var x = rect.X;
            var y = rect.Y;
        ...
        public static Point GetPointFrom(this CompassDirection direction, Quad rect)
        {
            Point result;
            var x = rect.X;
            var y = rect.Y;
