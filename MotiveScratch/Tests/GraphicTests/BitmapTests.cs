...
namespace Motive.Tests.GraphicTests
{
    public class BitmapTests : ITestScreen
    {
        ...
        private Components.Transitions.Timer _timer;

        public BitmapTests(Runner runner)
        {
            _runner = runner;
        ...
        public void NextVersion()
        {
            ...
            switch (_step)
            {
                case 0:
                    ...
                    _timer = new Components.Transitions.Timer(0, 1000, null);
                ...
                case 2:
                    ...
                    _runner.ActivateComposite(compRev.Id);
                    compRev.Runner.EndTimedEvent += CompOnEndTransitionEvent;
                    break;
                case 3:
                    _runner.ActivateComposite(containerA.Id);
                    _timer = new Components.Transitions.Timer(0, 500, null);
                    _timer.EndTimedEvent += CompOnEndTransitionEvent;
                    _runner.ActivateComposite(_timer.Id);
                    break;
                case 4:
     ...
     //               var compBlend = GetBlend(containerA, image2);
	                ...
	                _runner.ActivateComposite(compBlend.Id);
        ...
        public BlendTransition GetBlend(IContainer containerA, IContainer containerB, int ms)
        {
            ...
            var result = new BlendTransition(containerA, containerB, new Components.Transitions.Timer(0, ms), easeStore);
            return result;
        }
