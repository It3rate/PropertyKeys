...
namespace Motive.Tests.GraphicTests
{
    public class CompositeFlowerTest : ITestScreen
    {
        ...
        public CompositeFlowerTest(Runner runner)
        {
            _runner = runner;
        }
        ...
        public void NextVersion()
        {
            ...
            //var blend = new BlendTransition(comp, comp, 0, _runner.CurrentMs, 4000, easeStore);
            ...
            _runner.ActivateComposite(itemToAdd.Id);
        }
        ...
        public IContainer GetComposite0()
        {
            ...
            LinkingStore ls = new LinkingStore(_timer.Id, PropertyId.SampleAtT, SlotUtils.X, new FloatSeries(1, 0f, 1f).Store());
        ...
        public Container GetRing()
        {
	        ...
	        LinkingStore col = new LinkingStore(_timer.Id, PropertyId.EasedTCombined, SlotUtils.X, blendColors);
	        composite.AddProperty(PropertyId.FillColor, col); // new MergingStore(col, col2));

	        var growStore = new Store(new FloatSeries(1, 0f, 1f), new Easing(EasingType.EaseInOut3AndBack), CombineFunction.Multiply);
	        LinkingStore ls = new LinkingStore(_timer.Id, PropertyId.SampleAtT, SlotUtils.X, growStore);
