...
namespace PropertyKeys.Components
{
    public class Hexgrid
    {
        ...
        public Vector3Key Locations { get; set; }
        ...
        public void CreateGrid()
        {
            ...
            Locations = new Vector3Key(start, elementCount: Columns * Columns, dimensions: new int[] { Columns, 0, 0 }, sampleType: SampleType.Hexagon);
        }
    }
}
